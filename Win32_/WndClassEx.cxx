...
namespace fatpound::win32
{
    ...
    auto CALLBACK WndClassEx::HandleMsgSetup_(const HWND hWnd, const UINT msg, const WPARAM wParam, const LPARAM lParam) -> LRESULT
    {
        if (msg == WM_NCCREATE)
        {
#if UNICODE
...
#pragma warning (pop)
    ...
    auto CALLBACK WndClassEx::HandleMsgThunk_(const HWND hWnd, const UINT msg, const WPARAM wParam, const LPARAM lParam) -> LRESULT
    {
