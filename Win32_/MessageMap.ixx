...
#else
#define WIDEN_STRING(x) x
#endif

#define REGISTER_MESSAGE(msg) { static_cast<DWORD>(msg), WIDEN_STRING(#msg) }
    ...
    public:
        explicit MessageMap()
            ...
            m_map_({
                ...
                REGISTER_MESSAGE(WM_UAHDRAWMENU),
                REGISTER_MESSAGE(WM_UAHDRAWMENUITEM),
                REGISTER_MESSAGE(WM_UAHINITMENU),
                REGISTER_MESSAGE(WM_UAHMEASUREMENUITEM),
                REGISTER_MESSAGE(WM_UAHNCPAINTMENUPOPUP),
